...
define('FLOG', SITEROOT.'logs/scac.log');
...
function get_list_defs($default_path='') {
	$path = SITEROOT;
	return array(
		'up'   => '<img src="'.$path.'images/up-arrow.png" border="0" width="11"  height="5" alt="降序排序" >',
		'down' => '<img src="'.$path.'images/down-arrow.png" border="0" width="11" height="5" alt="升序排序" >',
		'SORT1'=> '<img src="'.$path.'images/up.jpg" border="0" width="13" height="11" alt="降序排序" >',
		'SORT2'=> '<img src="'.$path.'images/down.jpg" border="0" width="13" height="11" alt="升序排序" >',
		'wait' => '<img src="'.$path.'images/wait.gif" border="0" width="16" height="16" alt="正在处理..." >',
		'wait1'=> '<img alt="正在处理..." src="'.$path.'images/spinner.gif" width="16" height="16" border="0" style="visibility: hidden" class="wait">',
