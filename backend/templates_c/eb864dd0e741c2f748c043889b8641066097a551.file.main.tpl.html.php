<?php /* Smarty version Smarty-3.0.4, created on 2013-01-29 10:08:23
         compiled from ".//templates/main.tpl.html" */ ?>
<?php /*%%SmartyHeaderCode:35709028051081017060dc7-32613972%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'eb864dd0e741c2f748c043889b8641066097a551' => 
    array (
      0 => './/templates/main.tpl.html',
      1 => 1358384693,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '35709028051081017060dc7-32613972',
  'function' => 
  array (
  ),
...
<script type="text/javascript" src="<?php echo (isset($_smarty_tpl->getVariable('config')->value['path']) ? $_smarty_tpl->getVariable('config')->value['path'] : null);?>
include/bootstrap/js/bootstrap.js"></script>
...
<script src="<?php echo (isset($_smarty_tpl->getVariable('config')->value['path']) ? $_smarty_tpl->getVariable('config')->value['path'] : null);?>
...
<style type="text/css">
@import url(<?php echo (isset($_smarty_tpl->getVariable('config')->value['path']) ? $_smarty_tpl->getVariable('config')->value['path'] : null);?>
...
"><i class="icon-forward"></i>&nbsp;<?php echo (isset($_smarty_tpl->tpl_vars['v']->value) ? $_smarty_tpl->tpl_vars['v']->value : null);?>
</li>
    <?php }} ?>    
...
<?php }else{ ?>
  ...
  <?php if ((isset($_smarty_tpl->getVariable('config')->value['self']) ? $_smarty_tpl->getVariable('config')->value['self'] : null)=='emails'){?>
    $('#tab3').bind('click', function(event) {
	  var t = $('div.TabbedPanelsContentGroup').find('div.TabbedPanelsContent:eq(2) div:eq(0)');
	  if($(t).html().length==0) {
